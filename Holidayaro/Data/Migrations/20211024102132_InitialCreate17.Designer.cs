...
namespace Holidayaro.Data.Migrations
{
    ...
    [Migration("20211024102132_InitialCreate17")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Holidayaro.Models.HotelAttraction", b =>
                {
                    b.Property<int>("HotelAttractionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("HotelAttractionId");

                    b.HasIndex("HotelId");

                    b.ToTable("HotelAttraction");
                });
            ...
            modelBuilder.Entity("Holidayaro.Models.Payment", b =>
                {
                    ...
                    b.Property<string>("CreditCardExpirationMonth")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CreditCardExpirationYear")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Holidayaro.Models.Reservation", b =>
                {
                    b.Property<int>("ReservationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Holidayaro.Models.Payment", b =>
                {
                    b.HasOne("Holidayaro.Models.Reservation", "Reservation")
                        .WithMany()
